...
export function ServiceCenterTypeForm({ type }: Props) {
  ...
  async function onSubmit(values: FormValues) {
    ...
    try {
      const url = type
        ? `/api/jammanage/service-center-types/${type.id}`
        : '/api/jammanage/service-center-types';
      ...
      toast.success(
        type
          ? 'Service center type updated successfully'
          : 'Service center type created successfully',
      );

      router.push('/jammanage/service-center-types');
      router.refresh();
    } catch (error) {
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Enter a unique name for this service center type
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Inactive types will be hidden from selection
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
