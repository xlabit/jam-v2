        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
          {categories.map((category) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 rounded-full bg-[var(--jam-primary)]/10 flex items-center justify-center group-hover:bg-[var(--jam-primary)] transition-colors">
                  <IconComponent className="w-8 h-8 text-[#1e4a7c] group-hover:text-white transition-colors" />
                </div>
                <div>
                  <h3 className="jam-h4 text-[var(--jam-neutral-900)] mb-1">{category.name}</h3>
