      ...
      <div className="jam-container">
        <div className="flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-6" aria-label="Main navigation">
              <div className="relative group">
                <button
                  className="flex items-center gap-1 text-gray-700 hover:text-[#1e4a7c] jam-body font-medium transition-colors jam-focus-ring"
                  ...
                  >
                    {categories.map((category) => (
                      <Link
                        key={category.name}
                        href={category.href}
                        className="block px-4 py-2 hover:bg-gray-100 text-gray-700 hover:text-[#1e4a7c] transition-colors"
                        role="menuitem"
                      >
                        <div className="flex justify-between items-center">
                          <span className="jam-body">{category.name}</span>
                          <span className="jam-small text-gray-500">
                            {category.count}
                          </span>
                        </div>
                      </Link>
              ...
              <Link
                href="/brands"
                className="text-gray-700 hover:text-[#1e4a7c] jam-body font-medium transition-colors jam-focus-ring"
          ...
          <div className="flex items-center gap-3">
            <button
              className="hidden md:flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 transition-colors jam-focus-ring"
              aria-label="Search"
            ...
            <a
              ...
              className="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg bg-[var(--jam-primary)] text-white hover:bg-[var(--jam-primary)]/90 transition-colors jam-focus-ring"
            ...
            <button
              className="lg:hidden flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 transition-colors jam-focus-ring"
        ...
        {isMobileMenuOpen && (
          <nav className="lg:hidden py-4 border-t border-gray-200" aria-label="Mobile navigation">
            <div className="flex flex-col gap-2">
              <Link
                href="/vehicles"
                className="px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors jam-body font-medium"
              >
                Categories
              </Link>
              <Link
