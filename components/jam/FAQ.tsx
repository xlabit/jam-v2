          ...
          {faqs.map((faq) => (
            ...
            >
              <button
                ...
                className="w-full px-6 py-4 flex items-center justify-between text-left hover:bg-gray-50)] transition-colors jam-focus-ring"
                aria-expanded={openId === faq.id}
                aria-controls={`faq-answer-${faq.id}`}
              >
                <span className="jam-h4 text-[var(--jam-neutral-900)] pr-4">
                  {faq.question}
                </span>
                <ChevronDown
                  className={`w-6 h-6 text-[#1e4a7c] flex-shrink-0 transition-transform ${
              ...
              {openId === faq.id && (
                <div
                  ...
                  className="px-6 pb-4 jam-body text-gray-700"
                  role="region"
