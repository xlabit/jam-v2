  ...
  return (
    <section className="jam-section bg-[hsl(var(--jam-neutral-50))]">
      <div className="jam-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {valueProp.map((prop) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-[hsl(var(--jam-primary))]/10 flex items-center justify-center mb-4">
                  <IconComponent className="w-7 h-7 text-[hsl(var(--jam-primary))]" />
                </div>
                <h3 className="jam-h4 text-[hsl(var(--jam-neutral-900))] mb-2">
                  {prop.title}
                </h3>
        ...
        <div className="bg-gradient-to-r from-[hsl(var(--jam-primary))] to-[hsl(var(--jam-primary))]/90 rounded-2xl p-8 md:p-12 text-white mb-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="jam-h2 text-[hsl(var(--jam-accent))] mb-2">10K+</div>
              <div className="jam-body">Vehicles Listed</div>
            </div>
            <div>
              <div className="jam-h2 text-[hsl(var(--jam-accent))] mb-2">100+</div>
              <div className="jam-body">Cities Covered</div>
            </div>
            <div>
              <div className="jam-h2 text-[hsl(var(--jam-accent))] mb-2">1.5K+</div>
              <div className="jam-body">Fleet Owners</div>
            </div>
            <div>
              <div className="jam-h2 text-[hsl(var(--jam-accent))] mb-2">4.7★</div>
        ...
        <div>
          <h3 className="jam-h3 text-center text-[hsl(var(--jam-neutral-900))] mb-8">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12">
            {partners.map((partner) => (
              <div
                key={partner}
                className="bg-white px-6 py-4 rounded-lg shadow-sm text-[hsl(var(--jam-neutral-700))] font-semibold"
