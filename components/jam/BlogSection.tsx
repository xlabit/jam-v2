            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden rounded-t-lg">
                ...
                <div className="absolute top-3 left-3">
                  <span className="jam-tiny font-semibold px-3 py-1 rounded-full bg-[var(--jam-primary)] text-white">
                    {blog.category}
                  </span>
                </div>
              </div>
              ...
              <div className="p-6">
                <h3 className="jam-h4 text-[var(--jam-neutral-900)] mb-3 line-clamp-2 group-hover:text-[#1e4a7c] transition-colors">
                  {blog.title}
                </h3>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="jam-small text-[#1e4a7c] font-semibold group-hover:underline flex items-center gap-1">
                    Read More
                    <ArrowRight className="w-4 h-4" />
                  </span>
                </div>
