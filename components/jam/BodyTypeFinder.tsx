          ...
          {bodyTypes.map((type) => {
            ...
            return (
              <Link
                key={type.name}
                href={type.href}
                className="group relative overflow-hidden rounded-2xl bg-gradient-to-br bg-white border-2 border-transparent hover:border-[hsl(var(--jam-primary))] transition-all shadow-[var(--jam-elev-1)] hover:shadow-[var(--jam-elev-2)] hover:-translate-y-1"
              ...
              >
                <div className="p-6 flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    <h3 className="jam-h4 text-[hsl(var(--jam-neutral-900))] mb-1">{type.name}</h3>
                    <p className="jam-small text-[hsl(var(--jam-neutral-700))]">
                      {type.count.toLocaleString()} available
                    </p>
                  </div>
                  <div className="w-full pt-4 border-t border-[hsl(var(--jam-neutral-200))]">
                    <span className="jam-small text-[hsl(var(--jam-primary))] font-semibold group-hover:underline">
                      Explore →
                    </span>
                  </div>
                </div>
